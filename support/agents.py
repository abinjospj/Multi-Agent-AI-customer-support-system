...
# SUPPORT SYSTEM PROMPT --> Aparna's Job description
SUPPORT_SYSTEM_PROMPT = """
You are Aparna, a customer support agent at CoolBreeze AC.
...
SUPPORT_TOOLS = [
    {
        ...
        "description": "Fetch complete order details including status, carrier, tracking_number and days since order was placed. Use this when customer mentions their order or complains about delivery",
        "input_schema":{
            "type": "object",
            "properties": {
                "order_id": {
...
def run_risk_agent(user_id, conversation_id):
    ...
    AgentLog.objects.create(conversation=conv, event_type="risk", message=f"Starting fraud assesment for user with {user_id}")
    risk_messages = [
